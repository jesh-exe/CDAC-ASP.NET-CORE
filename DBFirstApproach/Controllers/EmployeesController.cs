...
namespace DBFirstApproach.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //Include is written to make sure the Lazy Fetch of DeptNavigation is Converted to Eager Fetch
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //Include is written to make sure the Lazy Fetch is Converted to Eager Fetch

            var employee = await _context.Employees.Include(e => e.DeptNoNavigation).FirstOrDefaultAsync(m => m.EmpNo == id);
            if (employee == null)
            {
                return NotFound();
            }

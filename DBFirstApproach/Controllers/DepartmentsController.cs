    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departments != null ? 
                          View(await _context.Departments.Include(o => o.Employees).ToListAsync()) :
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department = await _context.Departments.Include(o => o.Employees)
        ...
        public async Task<IActionResult> Create([Bind("DeptNo,Name")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeptNo,Name")] Department department)
        {
